 ...
 * This file demonstrates how to integrate Swapprism with a web frontend
 */

// For React/Vue/Angular applications
export class SwapprismClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new SwapprismClient(provider, contractAddress);
